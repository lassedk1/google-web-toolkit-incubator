...
function $clinit_92(){
  ...
  $clinit_46();
  impl_2 = new GlassPanelImplSafari();
}
...
function $matchDocumentSize(this$static, glassPanel){
  implMatchDocumentSize(glassPanel.element);
}

function implMatchDocumentSize(elem){
  var scrollWidth = getWindowScrollWidth();
  var scrollHeight = getWindowScrollHeight();
...
function GlassPanelImplSafari(){
}

_ = GlassPanelImplSafari.prototype = new GlassPanelImplStandard();
_.typeName$ = package_com_google_gwt_widgetideas_client_impl_ + 'GlassPanelImplSafari';
_.typeId$ = 0;
