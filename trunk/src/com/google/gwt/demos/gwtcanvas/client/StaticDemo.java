...
/**
 * Demo that showcases most of the GWTCanvas drawing API, as well as
 * transformations, and style settings.
 */
public class StaticDemo extends SimpleCanvasDemo {
  ...
  /*
   * Test cases derived from javascript test cases by Emil Eklund and from
   * Mozilla foundation Canvas tutorial. Please note that his test cases are NOT
   * bound by license since they were originally derived from mozilla foundation
   * test cases
   */
