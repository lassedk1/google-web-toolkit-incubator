...
public class GWTCanvasImplDefault implements GWTCanvasImpl {
  ...
  public native Element createElement() /*-{
    ...
    this.@com.google.gwt.widgetideas.graphics.client.impl.GWTCanvasImplDefault::setCanvasContext(Lcom/google/gwt/user/client/Element;)(e.getContext('2d'));
    return e;
  }-*/;
  ...
  private void setCanvasContext(Element ctx) {
