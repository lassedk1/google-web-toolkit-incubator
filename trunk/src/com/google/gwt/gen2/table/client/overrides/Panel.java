...
public abstract class Panel extends Gen2Widget implements HasWidgets {
  ...
  protected final void adopt(Widget child) {
    ...
    WidgetAdaptorImpl.setParent(child, this);
  }
  ...
  protected void adopt(Widget w, Element container) {
    ...
    WidgetAdaptorImpl.setParent(w, this);
  }
  ...
  protected void disown(Widget w) {
    ...
    WidgetAdaptorImpl.setParent(w, null);
  ...
  protected void doAttachChildren() {
    ...
    for (Iterator<Widget> it = iterator(); it.hasNext();) {
      ...
      WidgetAdaptorImpl.onAttach(child);
    }
  }
  ...
  protected void doDetachChildren() {
    ...
    for (Iterator<Widget> it = iterator(); it.hasNext();) {
      Widget child = it.next();
      WidgetAdaptorImpl.onDetach(child);
    }
  }
  ...
  protected final void orphan(Widget child) {
    ...
    WidgetAdaptorImpl.setParent(child, null);
  }
}
