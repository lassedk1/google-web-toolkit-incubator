...
import com.google.gwt.gen2.event.virtual.shared.VClickEvent;
import com.google.gwt.gen2.event.virtual.shared.VEventDataImpl;
...
public abstract class CanvasWidget {
  ...
  public void addMouseDownHanlder(VMouseDownHandler handler) {
    tryCreateManager();
    manager.addHandler(VMouseDownEvent.KEY, handler);
  }
