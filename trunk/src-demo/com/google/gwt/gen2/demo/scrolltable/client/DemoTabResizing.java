...
public class DemoTabResizing extends DemoTab implements ClickListener {
  ...
  private static final String DESC_STATIC_CHECKING = "Enable resize checking "
      ...
      + "fire the onResize() method in the ScrollTable, which implements " + "ResizableWidget.";
  ...
  public void onClick(Widget sender) {
    ...
    if (sender == toggleStaticCheckingButton) {
      ...
      DOM.setStyleAttribute(scrollTable.getElement(),
          heightWidthBox.getValue(heightWidthBox.getSelectedIndex()), heightWidthText.getText());
  ...
  protected Widget onInitialize() {
    ...
    panel.add(new HTML("<BR><B>Change the overall height/width of the table:</B>"));
