...
import com.google.gwt.gen2.table.client.ScrollTable.ColumnResizePolicy;
import com.google.gwt.gen2.table.client.ScrollTable.ResizePolicy;
...
public class DemoTabColumnWidth extends DemoTab implements ClickListener {
   ...
   */
  private Button columnResizePolicyButton = new Button("Set Column Resize Policy", this);
