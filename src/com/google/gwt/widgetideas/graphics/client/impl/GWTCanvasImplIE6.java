...
public class GWTCanvasImplIE6 implements GWTCanvasImpl {
  ...
  public void drawImage(ImageHandle img, int sourceX, int sourceY, int sourceWidth,
    ...
    Element elem = cloneElement(imagePrototype, true);
  ...
  public void fill() {
    ...
    Element elem = cloneElement(shapePrototype, true);
    ...
    Element fill = cloneElement(fillPrototype, true);
  ...
  public void stroke() {
    ...
    Element stroke = cloneElement(strokePrototype, true);
