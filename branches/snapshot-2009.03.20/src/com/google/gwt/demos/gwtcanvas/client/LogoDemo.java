...
public class LogoDemo extends SimpleCanvasDemo {
  ...
  private void renderingLoop() {
    ...
    canvas.clear();
    // Draw a static version of the logo, sampling the last 100x100
    // (image is 185x175) pixels of the image.
    // Draw starting at position 10, 10
    // scaled up by a factor of 2 on the canvas (using 200x200 as the
    // destination dimensions).
    canvas.drawImage(img, 84, 74, 100, 100, 10, 10, 200, 200);
