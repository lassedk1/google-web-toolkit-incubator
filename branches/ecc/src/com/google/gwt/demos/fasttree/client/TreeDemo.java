...
public class TreeDemo implements EntryPoint {
  ...
  public void onModuleLoad() {
    RootPanel.get().add(new TreeDemo().createDemo());
  }
  ...
  public void store() {
    Tree t = new Tree();
    TreeItem camping = t.addItem("Camping Gear");
    camping.addItem("Camping tents");
    TreeItem cooking = camping.addItem("Cooking gear");
    camping.setState(true);

    t.setSelectedItem(cooking);

    TreeItem ap = t.addItem("Apparel");
    ap.addItem("Jackets");
    ap.addItem("Shirts");
    t.addItem("Coolers");
    RootPanel.get().add(t);
  ...
  protected Widget basicTree() {
    Tree t = new Tree();
    t.setAnimationEnabled(false);
    TreeItem a = t.addItem("A root tree item");
    a.addItem("A child");
    TreeItem aXb = a.addItem("Another child");
    aXb.addItem("a grand child");
    TreeItem widgetBranch = a.addItem(new CheckBox("A checkbox child"));
    TreeItem textBoxParent = widgetBranch.addItem("A TextBox parent");
