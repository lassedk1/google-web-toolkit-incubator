...
/**
 * DatePicker widget displays a small Gregorian calendar dates to select a date
 * by the user.
 * 
 * <p>
...
public class DatePicker extends DialogBox implements ClickListener,
    ChangeListener, SourcesChangeEvents {
  ...
  /**
   * Public method onChange which is fired when user clicks on the list menu in
   * the widget.
   * 
  ...
  /**
   * Public method to get the value of the user selected date for the DatePicker
   * object.
   * 
  ...
  /**
   * Public method to set the default day and date of the widget. Date picker
   * for the given month and year will be displayed. The given date will be
   * marked as the selected date.
   * 
  ...
  /**
   * Public method to enable or disable displaying the trailing and leading
   * dates from previous and next months.
   * 
  ...
  private void colFormat(int tableRow, int tableCol, int weekendStart,
      int weekendEnd, DatePickerCell w) {
    String style;
  ...
  private void drawControlPane() {
    ...
    Widget yearControl = drawControls(dateTable.yearNames(),
        dateTable.yearName(), ACTION_PREV_YEAR, ACTION_NEXT_YEAR,
        ACTION_SET_YEAR);
    Widget monthControl = drawControls(dateTable.monthNames(),
        dateTable.monthName(), ACTION_PREV_MONTH, ACTION_NEXT_MONTH,
        ACTION_SET_MONTH);
  ...
  private Widget drawControls(ListBox names, Label name, int prev, int next,
      int set) {
