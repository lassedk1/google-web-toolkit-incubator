...
/**
 * Convenience class to help lazy loading. A LazyPanel is invisible by default,
 * and is only actually rendered when setVisible(true) is called. Intended to
 * work with{@link com.google.gwt.user.client.ui.StackPanel},
 * {@link com.google.gwet.user.client.ui.TabPanel},
 * {@link com.google.gwt.user.client.ui.DisclosurePanel}.
 * 
 * @param <T> widget type
 */
public abstract class LazyPanel<T extends Widget> extends
    SimplePanel {
  public LazyPanel() {
    setVisible(false);
  }
