 ...
 * type {@link com.google.gwt.user.client.ui.PopupListenerOverride}.
 */
public class PopupListenerCollectionOverride extends ArrayList<PopupListenerOverride> {
   ...
   */
  public void firePopupClosed(PopupPanelOverride sender, boolean autoClosed) {
    for (PopupListenerOverride listener : this) {
