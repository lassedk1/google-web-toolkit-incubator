...
/**
 * Wraps a java.util.Map around an {@link AbstractJsMap}. This will, in general,
 * be much slower that using the JsMap directly.
 * 
...
public abstract class JsMapAdaptor<KeyType, ValueType> extends
  ...
  /**
   * Checks that the key is valid for this type of map.
   */
  protected abstract KeyType checkKey(Object value);

  /**
   * Creates the underlying JavaScript object for this map.
   */
