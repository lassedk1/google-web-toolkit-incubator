 ...
 * keys/values that can be used in return for much faster speed and defines a
 * new map API. <br/> This map is optimized for the get/set operations. Use the
 * {@link JsMapAdaptor} class to get access to the more expensive java.util API.
 * <br/>. Global limitations on keys/values:
 * <ul>
 * <li>No null keys</li>
...
public abstract class AbstractJsMap<KeyType, ValueType> {
  private final JavaScriptObject proto = JavaScriptObject.createFunction();

  /**
   * The actual map used to store the key/value pairs.
   */
  protected final JavaScriptObject map;

  /**
   * Constructor.Package protected because we do not yet want to open this
   * interface up outside of gwt-incubator.
   */
  AbstractJsMap() {
    map = createMap(proto);
  }
