...
/**
 * This is a temporary class, is it an exact copy of 1.5 RC2's popup panel. As
 * soon as RC2 is out for a few days, this class and its associates will be
 * removed.
 */
public class PopupPanelOverride extends SimplePanel implements EventPreview,
    HasAnimation {

  /**
   * A callback that is used to set the position of a {@link PopupPanelOverride}
  ...
  public interface PositionCallback {
     ...
     * @see PopupPanelOverride#setPopupPositionAndShow(PositionCallback)
     */
  ...
  static class ResizeAnimation extends Animation {
    ...
    /**
     * The {@link PopupPanelOverride} being affected.
     */
    private PopupPanelOverride curPanel = null;
     ...
     */
    public ResizeAnimation(PopupPanelOverride panel) {
      this.curPanel = panel;
    }
  ...
  private PopupListenerCollectionOverride popupListeners;

  /**
   * Creates an empty popup panel. A child widget must be added to it before it
   * is shown.
   */
  public PopupPanelOverride() {
    super();
   ...
   */
  public PopupPanelOverride(boolean autoHide) {
    this();
   ...
   */
  public PopupPanelOverride(boolean autoHide, boolean modal) {
    this(autoHide);
    this.modal = modal;
  }

  public void addPopupListener(PopupListenerOverride listener) {
    if (popupListeners == null) {
      popupListeners = new PopupListenerCollectionOverride();
    }
   ...
   *          {@link PopupListenerOverride#onPopupClosed(PopupPanelOverride, boolean)}
  ...
  public void removePopupListener(PopupListenerOverride listener) {
    if (popupListeners != null) {
  ...
  /**
   * Enable or disable animation of the {@link PopupPanelOverride}.
   * 
