...
public class EventHandlers {
  private final HashMap<Class, ArrayList<EventHandler>> map = new HashMap();;
   ...
   */
  public boolean has(AbstractEvent event) {
    return has(event.getEventClass());
  }
  ...
  public boolean has(Class eventClass) {
    return map.get(eventClass) != null;
  }
