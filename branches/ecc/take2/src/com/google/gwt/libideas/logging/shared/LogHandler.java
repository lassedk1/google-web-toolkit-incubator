...
/**
 * A <tt>LogHandler</tt> object takes log messages from Log and publishes
 * them.
 * 
 * All LogHandler setup should be guarded by a call to Log.isLoggingEnabled()
 * 
 * A <tt>LogHandler</tt> can be disabled by doing a
 * <tt>setLevel(Level.OFF)</tt> and can be re-enabled by doing a
 * <tt>setLevel</tt> with an appropriate level.
 * <p>
 * 
 */
