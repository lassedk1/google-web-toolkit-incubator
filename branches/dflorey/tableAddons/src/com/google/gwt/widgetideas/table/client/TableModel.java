...
public abstract class TableModel<R> implements SourceTableModelEvents {
  ...
  /**
   * 
   * Allow table models to create column specific {@link ColumnFilter}
   * 
   * @param column the column for which the filter will be used
   * @return the column filer
   */
  public ColumnFilter createFilter(int column) {
    return null;
  }
