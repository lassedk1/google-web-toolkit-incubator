...
public class SortableGrid extends SelectionGrid {
  ...
  /**
   * The filterable columns listeners attached to this grid.
   */
  private FilterableColumnsListenerCollection filterableColumnsListeners = null;
  ...
  protected void fireColumnFiltered() {
    if (filterableColumnsListeners != null) {
      filterableColumnsListeners.fireColumnFiltered(columnFilterList);
    }
  }
