 ...
 */
public abstract class TreeTableModel<R extends TreeTableItem> extends
    ReadOnlyTableModel<R> {
  /**
  ...
  public static class Response<RowType extends TreeTableItem> extends
    ...
    public Response(Collection<Collection<Serializable>> rows, List<RowType> items,
        int rowCount) {
      super(rows, items);
