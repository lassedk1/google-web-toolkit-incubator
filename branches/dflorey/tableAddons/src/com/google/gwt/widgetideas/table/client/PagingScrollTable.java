...
import com.google.gwt.widgetideas.table.client.SortableGrid.ColumnFilterCallback;
import com.google.gwt.widgetideas.table.client.SortableGrid.ColumnFilterer;
...
public class PagingScrollTable<R> extends ScrollTable implements
  ...
  public void gotoPage(int page, boolean forced) {
    ...
    if (currentPage != oldPage || forced) {
      ...
      Request request = createRequest(currentPage * pageSize, pageSize,
