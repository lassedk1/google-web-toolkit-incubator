...
public class ColumnDateFilterInfo extends ColumnFilterInfo {
   ...
   */
  public ColumnDateFilterInfo(int column, String datePattern,
  ...
  /* (non-Javadoc)
   * @see com.google.gwt.widgetideas.table.client.TableModel.ColumnFilterInfo#isFilterMatchingCellContent(java.lang.String)
   */
  ...
  /* (non-Javadoc)
   * @see com.google.gwt.widgetideas.table.client.TableModel.ColumnFilterInfo#isFilterMatchingValueObject(java.lang.Object)
   */
