...
function round_int(x){
  if (x > ($clinit_108() , MAX_VALUE))
    return $clinit_108() , MAX_VALUE;
  if (x < ($clinit_108() , MIN_VALUE))
    return $clinit_108() , MIN_VALUE;
...
function $DialogBox_0(this$static, autoHide, modal){
  ...
  $setAlignment(this$static.panel.cellFormatter, 1, 0, ($clinit_58() , ALIGN_CENTER), ($clinit_61() , ALIGN_MIDDLE));
...
function onWindowClosed_0(){
  var gwt, it;
  for (it = $iterator_2($values(($clinit_72() , rootPanels))); $hasNext_3(it);) {
...
function onWindowResized(width, height){
  $matchDocumentSize(($clinit_92() , impl_2), this.this$0);
}
...
function $HashMap$EntrySetIterator(this$static, this$0){
  ...
  if (this$static.this$0.nullSlot !== ($clinit_135() , UNDEFINED)) {
