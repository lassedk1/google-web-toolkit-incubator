...
public class MouseDownEvent extends BrowserEvent<MouseDownHandler> {

  public static Key KEY = new Key(BrowserEvents.ONMOUSEDOWN);

  protected MouseDownEvent(Event e) {
    super(e);
  }
