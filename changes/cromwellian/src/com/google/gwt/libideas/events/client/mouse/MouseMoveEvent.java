...
public class MouseMoveEvent extends BrowserEvent<MouseMoveHandler> {

  public static Key KEY = new Key(BrowserEvents.ONMOUSEMOVE);

  protected MouseMoveEvent(Event e) {
    super(e);  
  }
