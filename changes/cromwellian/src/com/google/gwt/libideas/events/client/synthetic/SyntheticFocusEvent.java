...
import com.google.gwt.libideas.events.client.mouse.FocusEvent;
import com.google.gwt.libideas.events.client.keyboard.KeyDownEvent;

public class SyntheticFocusEvent extends FocusEvent {

  private EventData data;

  public static AbstractEvent.Key KEY = new AbstractEvent.Key();

  public SyntheticFocusEvent(EventData data) {
    super(null);
    this.data = data;
  }
