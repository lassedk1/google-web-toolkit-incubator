...
/**
 * Helper class to produce trees.
 * 
 */
public class TreeHelper implements EntryPoint {
  /**
   * Tree types
   */
  public static class TreeType {
    public static TreeType TEXT = new TreeType();
    public static TreeType HTML = new TreeType();
    public static TreeType CHECKBOX = new TreeType();
