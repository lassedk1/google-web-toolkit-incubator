...
function round_int(x){
  if (x > ($clinit_107() , MAX_VALUE))
    return $clinit_107() , MAX_VALUE;
  if (x < ($clinit_107() , MIN_VALUE))
    return $clinit_107() , MIN_VALUE;
...
function $clinit_91(){
  ...
  $clinit_46();
  impl_2 = new GlassPanelImplOpera();
}
...
function GlassPanelImplOpera(){
}

_ = GlassPanelImplOpera.prototype = new GlassPanelImplStandard();
_.typeName$ = package_com_google_gwt_widgetideas_client_impl_ + 'GlassPanelImplOpera';
_.typeId$ = 0;
...
function $HashMap$EntrySetIterator(this$static, this$0){
  ...
  if (this$static.this$0.nullSlot !== ($clinit_134() , UNDEFINED)) {
