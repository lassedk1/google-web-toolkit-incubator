function com_google_gwt_demos_glasspanel_GlassPanelDemo(){
  ...
  function maybeStartModule(){
    if (gwtOnLoad && bodyDone) {
      gwtOnLoad(onLoadErrorFunc, 'com.google.gwt.demos.glasspanel.GlassPanelDemo', base);
    }
  }

  function computeScriptBase(){
    var thisScript, markerScript;
    $doc.write('<script id="__gwt_marker_com.google.gwt.demos.glasspanel.GlassPanelDemo"><\/script>');
    markerScript = $doc.getElementById('__gwt_marker_com.google.gwt.demos.glasspanel.GlassPanelDemo');
    if (markerScript) {
  ...
  com_google_gwt_demos_glasspanel_GlassPanelDemo.onScriptLoad = function(gwtOnLoadFunc){
